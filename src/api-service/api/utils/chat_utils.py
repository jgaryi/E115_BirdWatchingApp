...
class ChatHistoryManager:
    def __init__(self, model, history_dir: str = "chat-history"):
        ...
        self.audio_dir = os.path.join(self.history_dir, "audio")
    ...
    def _save_image(self, chat_id: str, message_id: str, audio_data: str) -> str:
        """
        ...
        try:
            ...
            if ',' in base64_string:
                ...
                mime_type = 'audio/mp3'  # default to mp3 if no header
    ...
    def save_chat(self, chat_to_save: Dict, session_id: str) -> None:
        """Save a chat to both memory and file, handling audio separately"""
        chat_dir = os.path.join(self.history_dir,session_id)
        os.makedirs(chat_dir, exist_ok=True)
        
        # Process messages to save audio separately
