...
import { Home, Info, Podcasts, Map, SmartToy, ChatBubbleOutline } from '@mui/icons-material';
...
const navItems = [
    ...
    { name: 'Bird Sounds Explorer', path: '/podcasts', sectionId: 'podcasts', icon: <Podcasts fontSize="small" /> },
    { name: 'Interactive Maps', path: '/newsletters', sectionId: 'newsletters', icon: <Map fontSize="small" /> },
