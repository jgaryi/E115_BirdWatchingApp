...
const DataService = {
    ...
    Getbird_sounds: async function (limit) {
        return await api.get(BASE_API_URL + "/bird_sounds?limit=" + limit);
    },
    ...
    Getbird_soundAudio: function (audio_path) {
        return BASE_API_URL + "/bird_sounds/audio/" + audio_path;
    },
    ...
    Getbird_mapImage: function (image_path) {
        return BASE_API_URL + "/bird_maps/image/" + image_path;
    },
