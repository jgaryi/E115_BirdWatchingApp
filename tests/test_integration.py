...
audio_path = os.path.join(current_dir, "test.mp3")  # Replace with your actual test audio file path

# Dynamically locate the Hapalopsittaca_sample.mp3 file
current_dir1 = os.path.dirname(os.path.abspath(__file__))
audio_path1 = os.path.join(current_dir1, "Hapalopsittaca_sample.mp3")  # Replace with your actual test audio file path
