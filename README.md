...
We compiled detailed bird information from three authoritative sources: 
https://www.peruaves.org/ (2) 
https://ebird.org/home (3) 
https://en.wikipedia.org/wiki/Main_Page (4). The dataset consists of nine integrated text files (one per species) and forty-seven bird images. Due to copyright considerations, we only included abstracts from Google Scholar (Source 8) rather than full scientific articles.
